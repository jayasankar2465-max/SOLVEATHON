...
sentiment_model = DistilBertForSequenceClassification.from_pretrained("distilbert-sentiment").to(device)
sentiment_tokenizer = DistilBertTokenizerFast.from_pretrained("distilbert-sentiment")

t5_model = T5ForConditionalGeneration.from_pretrained("t5-absa").to(device)
